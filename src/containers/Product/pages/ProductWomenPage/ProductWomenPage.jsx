...
import ListProductWomenPage from './ListProductWomenPage';
import Pagination from '../Pagination';
import { CartContext } from '../../../../features/Contexts/CartProvider';
import { useContext } from 'react';
import { BrowserRouter as Router, Link } from 'react-router-dom';

ProductWomenPage.propTypes = {};

function ProductWomenPage(props) {
    ...
    useEffect(() => {
        fetch("https://60d1f5d75b017400178f4cb3.mockapi.io/productswomen")
            .then(res => res.json())
            .then((result) => {
                setSanPham(result);
            },
                    ...
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="banner__text">
                                <span class="banner__heading">NỮ</span>
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-xl-9">
                        ...
                        <div className="row">
                            <ListProductWomenPage sanPham={currentPost}></ListProductWomenPage>
                        </div>
