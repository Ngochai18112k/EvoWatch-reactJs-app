...
function Intro(props) {
    return (
        <div>
            ...
            <div id="intro">
                <div className="container">
                    <p className="intro__text">Kiến thức về đồng hồ, thông tin khuyến mãi, tin tức & sự kiện, hình ảnh, video clip về đồng hồ đeo tay mới nhất hiện nay, cập nhật liên tục nhanh và đầy đủ...</p>
                </div>
            </div>
        </div>
    );
